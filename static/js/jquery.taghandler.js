...
(function($) {
    ...
    $.fn.tagHandler = function(options) {
        ...
        return this.each(function() {
            ...
            $('body').append('<div id="textwidthdiv" style="position:absolute;visibility:hidden;font:bold 12px Verdana;"></div>');
            ...
            if (opts.allowEdit) {
                $(tagContainer).html('<li class="tagInput"><input id="tags" class="tagInputField tooltip" type="text" /></li>');
            }
            ...
            if (opts.allowEdit) {
                ...
                $(inputField).keydown(function(e) {
                	...
                	$('#textwidthdiv').html($(this).val());
                    $(this).width($('#textwidthdiv').width() + 16);
                });
